...
# === CONFIGURATION ===
BOT_TOKEN = '7877458054:AAFaaZKMud2u-95QdEjA6ws82GBe7gx3SLA'  # Replace with your actual bot token
bot = telebot.TeleBot(BOT_TOKEN)

admin_id = {"7769457936"}
EXEMPTED_USERS = [7769457936]
...
def hack_cmd(msg):
    ...
    args = msg.text.split()
    if len(args) != 4:
        return bot.reply_to(msg, "Usage: /bgmi <IP> <PORT> <TIME>")
